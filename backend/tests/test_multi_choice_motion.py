...
class TestSubmitBallotMultiChoice:
    ...
    async def test_submit_multi_choice_ballot_happy_path(
        ...
        payload = {
            ...
            "multi_choice_votes": [
                {"motion_id": mc_motion["id"], "option_ids": [alice_opt_id, bob_opt_id]}
            ],
        }
    ...
    async def test_submit_mc_abstain_when_no_options_selected(
        ...
        payload = {
            ...
            "votes": [],
            "multi_choice_votes": [
                {"motion_id": mc_motion["id"], "option_ids": []}
            ],
        }
        resp = await client.post(
            f"/api/general-meeting/{meeting_id}/submit",
    ...
    async def test_submit_with_invalid_option_id_rejected(
        ...
        payload = {
            ...
            "votes": [],
            "multi_choice_votes": [
                {"motion_id": mc_motion["id"], "option_ids": [fake_option_id]}
            ],
        }
        resp = await client.post(
            f"/api/general-meeting/{meeting_id}/submit",
    ...
    async def test_submit_exceeding_option_limit_rejected(
        ...
        payload = {
            ...
            "votes": [],
            "multi_choice_votes": [
                {"motion_id": mc_motion["id"], "option_ids": opt_ids}  # 3 opts, limit=2
            ],
        }
        resp = await client.post(
            f"/api/general-meeting/{meeting_id}/submit",
    ...
    async def test_submit_unknown_mc_motion_id_rejected(
        ...
        payload = {
            ...
            "votes": [],
            "multi_choice_votes": [
                {"motion_id": str(uuid.uuid4()), "option_ids": [str(uuid.uuid4())]}
            ],
        }
        resp = await client.post(
            f"/api/general-meeting/{meeting_id}/submit",
    ...
    async def test_in_arrear_lot_gets_not_eligible_on_mc_motion(
        ...
        submit_payload = {
            ...
            "votes": [],
            "multi_choice_votes": [
                {"motion_id": mc_motion_id, "option_ids": [alice_opt_id]}
            ],
        }
        resp = await client.post(
            f"/api/general-meeting/{meeting_id}/submit",
